...
int main(int argc, char ** argv) {
  ...
  do {
    ...
    progNormalMap.setUniform(mvpLocationNormalMap, p*v*mBall);
    ...
    const Mat4 mLeftWall{Mat4::translation(-2.0f,0.0f,0.0f)*Mat4::rotationY(-90)};
    ...
    const Mat4 mRightWall{Mat4::translation(2.0f,0.0f,0.0f)*Mat4::rotationY(90)};
    progNormalMap.setUniform(mvpLocationNormalMap, p*v*mRightWall);
    ...
    const Mat4 mTopWall{Mat4::translation(0.0f,2.0f,0.0f)*Mat4::rotationX(-90)};
    ...
    const Mat4 mBottomWall{Mat4::translation(0.0f,-2.0f,0.0f)*Mat4::rotationX(90)};
